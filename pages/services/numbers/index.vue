...
import NumbersTable from "@/components/TheServices/TheNumbers/NumbersTable.vue";
import AddNewNumbers from "@/components/TheServices/TheNumbers/AddNewNumbers.vue";
...
const getNumbersApi = async () => {
  const result = await serviceNumbersStore.getNumbers(1)
