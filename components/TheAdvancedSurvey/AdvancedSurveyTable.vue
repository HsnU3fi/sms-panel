    ...
    <el-table-column width="20">
      <template #default="scope">
        <el-dropdown placement="left">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="emit('showSurveyModal')"
                ><Icon name="setting" /> Options</el-dropdown-item
              >
              <el-dropdown-item @click="handleDelete(scope.$index, scope.row)"
                ><Icon name="message-tick" /> Reply</el-dropdown-item
              >
              <el-dropdown-item
                ><Icon name="ranking" /> Lottery
              </el-dropdown-item>
              <el-dropdown-item @click="handleDelete(scope.$index, scope.row)"
                ><Icon name="chart" /> Chart
              </el-dropdown-item>
...
const emit = defineEmits("showSurveyModal");
