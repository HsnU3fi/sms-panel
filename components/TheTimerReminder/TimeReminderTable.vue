<template>
  ...
  >
    ...
    ></el-table-column>
    <el-table-column property="Duration" label="Duration"
      ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="SendDate" label="Send Date" show-overflow-tooltip
      ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="SendStatus" label="Send Status"
      ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
