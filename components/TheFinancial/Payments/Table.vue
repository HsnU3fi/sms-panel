<template>
  ...
  >
    ...
    ></el-table-column>
    <el-table-column property="For" label="For"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="Status" label="Status"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="Bank" label="Bank"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="PaymentID" label="Payment ID"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="information" label="User information"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="StartDate" label="Start Date"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
    <el-table-column property="EndDate" label="End Date"
    ><template #header v-if="multipleSelection.length"> </template
    ></el-table-column>
