<template>
  ...
  >
    ...
    <el-table-column property="Period" label="Period"></el-table-column>
    ...
    <el-table-column
      ...
      width="100"
    ></el-table-column>
    <el-table-column property="SendStatus" label="SendStatus"></el-table-column>
