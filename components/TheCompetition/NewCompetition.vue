  ...
  <section class="form-item">
    <section class="row">
      <section class="col-12 col-md-6">
        <label class="label">positive score</label>
        <input
          type="number"
          placeholder="positive score"
          v-model="state.positiveScore"
          />
      </section>
      <section class="col-12 col-md-6">
        <label class="label">Negative score</label>
        <input
            type="number"
            placeholder="positive score"
            v-model="state.negativeScore"
        />
      </section>
    </section>
  </section>
  <section class="form-item">
    <label class="label">Start Competition  Text</label>
    <textarea
      v-model="state.startText"
      rows="10"
      />
  </section>
  <section class="form-item">
    <label class="label">End Competition Text</label>
    <textarea
      v-model="state.endText"
      rows="10"
      />
  </section>
  <section class="form-item">
